...
?>
    ...
    <!-- Pied de page -->
    <footer class="bg-[#0c4633] text-white py-6">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul>
                        <li class="mb-2"><a href="index.php" class="hover:text-[#a37e2c]">Accueil</a></li>
                        <li class="mb-2"><a href="shop.php" class="hover:text-[#a37e2c]">Boutique</a></li>
                        <li class="mb-2"><a href="#" class="hover:text-[#a37e2c]">À propos</a></li>
                        <li class="mb-2"><a href="#" class="hover:text-[#a37e2c]">Conditions générales</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <form class="flex">
                        ...
                        <button class="bg-[#a37e2c] px-4 py-2 rounded-r hover:bg-[#c19940]">

            ...
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="w-full md:w-1/3 mb-4 md:mb-0">
                    <form action="shop.php" method="get" class="flex">
                        ...
                        <button type="submit" class="bg-blue-600 px-4 py-2 rounded-r hover:bg-blue-700">
                ...
                <nav>
                    <ul class="flex space-x-4">
                        ...
                        <li><a href="shop.php" class="hover:text-blue-300">Boutique</a></li>
                        <?php if (isLoggedIn()): ?>
                            <li><a href="profile.php" class="hover:text-blue-300">Profil</a></li>
                            <?php if (isAdmin()): ?>
                                <li><a href="admin/index.php" class="hover:text-blue-300">Admin</a></li>
                            <?php endif; ?>
                            <li><a href="logout.php" class="hover:text-blue-300">Déconnexion</a></li>
                        <?php else: ?>
                            <li><a href="login.php" class="hover:text-blue-300">Connexion</a></li>
                        <?php endif; ?>
                        <li>
                            <a href="cart.php" class="hover:text-blue-300 relative">
